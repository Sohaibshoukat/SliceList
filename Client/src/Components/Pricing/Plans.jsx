    ...
    return (
        <div className='w-[95%] md:w-[90%] xl:w-[80%] m-auto pt-0 pb-4 xl:py-8'>
            <div className='flex justify-center items-center m-auto w-[90%] lg:w-[60%] xl:w-[40%] bg-black rounded-xl text-xl md:text-2xl font-bold text-white p-1 mb-10 md:mb-20'>
                ...
                <div className={`cursor-pointer flex gap-2 basis-[50%] px-1 md:px-2 py-2 justify-center items-center ${selected == "Yearly" && "bg-white text-black rounded-xl bounceright"} duration-300 ease-in-out`} onClick={() => { toggleSelected("Yearly") }}>
                    <h1>Yearly</h1>
                    <div className='hidden md:flex gap-2 text-xs md:text-base  justify-center items-center font-light'>
            ...
            <div className='grid w-[90%] md:w-auto m-auto justify-center items-center gap-y-8 gap-x-4 lg:gap-x-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3'>
                {PricingPlan.map((item, index) => (
                    <div className={`border-t-[40px] border-b-[20px] border-x-[20px] ${item.Best ? 'border-[#ADFC32]' : 'border-black'} rounded-lg relative bg-black text-white h-full shadow-xl hover:-translate-y-3 hover:shadow-2xl duration-300 ease-in-out`}>
                        {item.Best && (
                        ...
                        <div className='rounded-3xl p-8'>
                            ...
                            <button
                                className='py-2 px-4 rounded-full mb-10 text-xl font-bold text-white bg-transparent border-2 border-white hover:bg-accence hover:border-[#ADFC32] hover:text-black duration-300 ease-in-out'
                            >
                                {item.BtnText}
                            </button>
