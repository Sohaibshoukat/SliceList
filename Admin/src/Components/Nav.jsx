...
const Nav = () => {
    ...
    return (
        <div className={`flex-col bg-white xl:h-full h-screen px-5 pt-8 w-20 md:w-72 items-center shadow-md`}>
            <img className='hidden sm:block pb-5' src='./assets/Logo.png'></img>
