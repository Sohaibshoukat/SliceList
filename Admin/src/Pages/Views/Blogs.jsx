...
const Blogs = () => {
  return (
    <div className='xl:flex lg:p-4 p-2 shadow-md m-2 min-h-screen '>

      <div className='lg:w-[80%] mx-4 overflow-y-auto lg:px-10 px-2'>
      ...
      <div className='flex-col mx-auto p-4 xl:border-l md:w-[40%] xl:w-[20%] md:border-darkgray'>
        ...
        <FaPlusCircle className='text-secondary font-bold md:text-lg text-xl p-2 my-1 bg-[#2A6B45] rounded-full h-full w-10'/>
        </div>
